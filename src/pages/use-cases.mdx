...
Collect and cost-effectively store the large amounts of data (terabytes/petabytes) 
Replay the raw data into the high speed transformer, collect the result and refeed it into the feature store preparing for the retraining
Replay the event streams for model testing 
...
Modifying and structuring data to write into the defined storage with possible loss of original raw data
Significant cost of database maintenance, storage expansion and operations 
DevOps involvement to orchestrate the Replay process
...
<img style={{width: '100%', background: 'white', margin: '20px auto'}} src="/use-case/scenario-1.png" />
